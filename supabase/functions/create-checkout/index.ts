...
const PLANS: Record<string, { price_id: string; mode: "subscription" | "payment" }> = {
  monthly: { price_id: "price_1T8vVEPWpQvSHSnqPVzx0ef6", mode: "subscription" },
  yearly: { price_id: "price_1T8vVSPWpQvSHSnqXwNi1eud", mode: "subscription" },
  lifetime: { price_id: "price_1T8vVSPWpQvSHSnqfGCJZc9I", mode: "payment" },
};
...
serve(async (req) => {
  ...
  try {
    ...
    const origin = req.headers.get("origin") || "https://trakpay.lovable.app";
